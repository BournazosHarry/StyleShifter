...
export class ColorUtils {
   ...
   */
  public static cssColorToRGBA(color: string): [number, number, number, number] {
    if (color.startsWith('#')) {
  ...
  private static rgbStringToRGBA(rgb: string): [number, number, number, number] {
   ...
   */
  public static rgbaToHex(r: number, g: number, b: number, a: number = 255): string {
