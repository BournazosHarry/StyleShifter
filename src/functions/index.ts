 ...
 */
export const url: APIFunction = (expression, theme, src, parserPos, args) => {
 ...
 */
export const toPx: APIFunction = (expression, theme, src, parserPos, args) => {
  if (args[0] == null) return null;
 ...
 */
function getUnit(val: string): string {
  if (val.startsWith('.')) {
    val = '0' + val;
  }
 ...
 */
export const toRem: APIFunction = (expression, theme, src, parserPos, args) => {
  if (args[0] == null) return null;
 ...
 */
export const opacify: APIFunction = (expression, theme, src, parserPos, args) => {
  if (args[0] == null) return null;
 ...
 */
export const tint: APIFunction = (expression, theme, src, parserPos, args) => {
 ...
 */
export const invert: APIFunction = (expression, theme, src, parserPos, args) => {
  if (args[0] == null) return null;
 ...
 */
export const printf: APIFunction = (expression, theme, src, parserPos, args) => {
  if (args[0] == null) return null;
